...
public class Facade implements IFacade{
	...
	private final static String earName = "DepositoEAR"; // Nombre del módulo EAR
	private final static String ejbModuleName = "Backend"; // Nombre del módulo EJB
	...
	private final static String fullInterfaceName = ArticuloServiceRemote.class.getName();
	...
	private static ArticuloServiceRemote mbr;
	
	public static final Facade getInstance() throws NamingException{
		if (facade == null){
			facade = new Facade();
			Context context = new InitialContext(jndiProperties);
			mbr = (ArticuloServiceRemote) context.lookup(lookupName);
		}
		return facade;
	}
